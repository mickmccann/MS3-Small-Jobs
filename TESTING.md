...
Ensure website passes JSHint validators | The script.js file passes the JSHint validation with just these two warnings: Two warnings 20	'let' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz) 21	'let' is available in ES6 (use 'esversion: 6') or Mozilla JS extensions (use moz) | PASS
